  ...
  try {
    if (type === 'init') {
      ...
      send('explanation', {text: plan.text, score: base.score, tokens: base.ids.length, spans,
        ...
        method: base.score.calibrated ? 'one-span-space-occlusion; delta=calibrated_IQ(original)-calibrated_IQ(occluded); NOT additive/causal' : 'one-span-space-occlusion; delta=0.6*(raw_original-raw_occluded); NOT additive/causal'});
