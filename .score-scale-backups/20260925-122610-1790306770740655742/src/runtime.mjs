...
async function verifyParity(engine, parity, progress) {
  let maxEmbeddingError = 0, maxScoreError = 0;
  ...
  return {passed: true, cases: parity.cases.length, max_embedding_error: maxEmbeddingError, max_raw_score_error: maxScoreError};
}
